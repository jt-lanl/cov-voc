DefaultLineageTable = [
    ...
    ('LightSkyBlue',               'BA.2', r'((BA\.2)|(B[GHJLMNPRSY])|(C[ABHJMV])|(D[DSV])|(E[JP])|(F[JKRSV])|(G[PQ])|(J[LNPQV])|(K[GPQRSUVWYZ])|(L[ABCDEFGHJKLMNPQRSTUVWYZ])|(M[ABCDEFGHJKLMNPQRSTUVWY]))(\..*)?'),
    ...
    (  'DodgerBlue',            'BA.2.86', r'((BA\.2\.86)|(J[NQ])|(K[PQRSUVWYZ])|(L[ABCDEFGHJKLMNPQRSTUVWYZ])|(M[ABCDEFGHJKLMNPQRSTUVWY]))(\..*)?'),
    (        'Cyan',               'JN.1', r'((JN\.1)|(K[PQRSUVWYZ])|(L[ABCDEFGHJKLMNPQRSTUWYZ])|(M[ABCDEFGHJKLMNQRSTUVWY]))(\..*)?'),
    (    'DarkBLue',               'KP.2', r'((KP\.2)|(MW))(\..*)?'),
    (   'RoyalBlue',             'KP.2.3', r'((KP\.2\.3)|(MW))(\..*)?'),
    (   'LightBlue',               'KP.3', r'((KP\.3)|(LW)|(M[CKLMRY]))(\..*)?'),
    (   'SlateBlue',           'KP.3.1.1', r'((KP\.3\.1\.1)|(MC))(\..*)?'),
    (      'Yellow',                'XDQ', r'XDQ(\..*)?'),
    (       'Coral',               'LB.1', r'((LB\.1)|(MH))(\..*)?'),
