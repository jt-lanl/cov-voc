DefaultLineageTable = [
    ...
    ('LightSkyBlue',               'BA.2', r'((BA\.2)|(B[GHJLMNPRSY])|(C[ABHJMV])|(D[DSV])|(E[JP])|(F[JKRSV])|(G[PQ])|(J[LNPQV])|(K[GPQRSUVWYZ])|(L[ABCDEFGHJKLMNPQRSTUVWYZ])|(M[ABCDEFGHJKLMNPQRSTUVWYZ])|(N[ACDEFGHJKLMNPQRSTUV]))(\..*)?'),
    ...
    (  'DodgerBlue',            'BA.2.86', r'((BA\.2\.86)|(J[NQ])|(K[PQRSUVWYZ])|(L[ABCDEFGHJKLMNPQRSTUVWYZ])|(M[ABCDEFGHJKLMNPQRSTUVWYZ])|(N[ACDEFGHJKLMNPQRSTUV]))(\..*)?'),
    (        'Cyan',               'JN.1', r'((JN\.1)|(K[PQRSUVWYZ])|(L[ABCDEFGHJKLMNPQRSTUWYZ])|(M[ABCDEFGHJKLMNQRSTUVWYZ])|(N[ACDEFGHJKLMNPQRSTUV]))(\..*)?'),
    (       'Brown',               'KP.1', r'((KP\.1)|(LP)|(M[GU])|(NE))(\..*)?'),
    (   'RoyalBlue',               'KP.2', r'((KP\.2)|(MW)|(N[GHKMN]))(\..*)?'),
    (    'DarkBlue',             'KP.2.3', r'((KP\.2\.3)|(MW)|(N[GKMN]))(\..*)?'),
    (        'Plum',               'KP.3', r'((KP\.3)|(LW)|(M[CKLMRY])|(N[PQRV]))(\..*)?'),
    (     'Magenta',           'KP.3.1.1', r'((KP\.3\.1\.1)|(MC))(\..*)?'),
    (  'DodgerBlue',               'MC.1', r'MC\.1(\..*)?'),
    (       'Khaki',             'LP.8.1', r'LP\.8\.1(\..*)?'),
    (       'Coral',           'LP.8.1.1', r'LP\.8\.1\.1(\..*)?'),
