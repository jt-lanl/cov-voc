DefaultLineageTable = [
    ...
    (   'RoyalBlue',               'BA.2', r'((BA\.2)|(B[GHJLMNPRSY])|(C[ABHJMV])|(D[DSV])|(E[JP])|(F[JKRSV])|(G[PQ])|(J[LNPQV])|(K[GPQRSUVWYZ])|(L[ABCDEFGHJKLMNPQRSTUVW]))(\..*)?'),
    ...
    (   'Goldenrod',                 'GK', r'GK(\..*)?'),
    (       'Brown',               'JD.1', r'((JD\.1)|(KK))(\..*)?'),
    ('LightSkyBlue',           'XBB.1.16', r'((XBB\.1\.16)|(FU)|(GY)|(HF)|(J[FM])|(KJ))(\..*)?'),
    (   'LimeGreen',               'CH.1', r'((CH\.1)|(DV)|(F[JKS])|(G[PQ])|(J[LPV])|(KG))(\..*)?'),
    (       'Khaki',               'BN.1', r'((BN\.1)|(DS)|(EJ)|(FR))(\..*)?'),
    (      'Purple',             'EG.5.1', r'((EG\.5\.1)|(H[KV])|(J[GJR])|(K[BL]))(\..*)?'),
    (     'Thistle',               'HK.3', r'HK\.3(\..*)?'),
    (      'Violet',               'HV.1', r'((HV\.1)|(KL))(\..*)?'),
    (  'DarkOrange',           'FL.1.5.1', r'((FL\.1\.5\.1)|(HN))(\..*)?'),
    ...
    (  'DodgerBlue',            'BA.2.86', r'((BA\.2\.86)|(J[NQ])|(K[PQRSUVWYZ])|(L[ABCDEFGHJKLMNPQRSTUVW]))(\..*)?'),
    (        'Cyan',               'JN.1', r'((JN\.1)|(K[PQRSUVWYZ])|(L[ABCDEFGHJKLMNPQRSTUW]))(\..*)?'),
    (    'DarkBLue',               'KP.2', r'KP\.2(\..*)?'),
    (   'LightBlue',               'KP.3', r'((KP\.3)|(LW))(\..*)?'),
    (   'SlateBlue',           'KP.3.1.1', r'KP\.3\.1\.1(\..*)?'),
    (      'Yellow',                'XDQ', r'XDQ(\..*)?'),
    (       'Coral',               'LB.1', r'LB\.1(\..*)?'),
