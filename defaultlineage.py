DefaultLineageTable = [
    ...
    ('LightSkyBlue',               'BA.2', r'((BA\.2)|(B[GHJLMNPRSY])|(C[ABHJMV])|(D[DSV])|(E[JP])|(F[JKRSV])|(G[PQ])|(J[LNPQV])|(K[GPQRSUVWYZ])|(L[ABCDEFGHJKLMNPQRSTUVWYZ])|(M[ABCDEFGHJKLMN]))(\..*)?'),
    ...
    (  'DodgerBlue',            'BA.2.86', r'((BA\.2\.86)|(J[NQ])|(K[PQRSUVWYZ])|(L[ABCDEFGHJKLMNPQRSTUVWYZ])|(M[ABCDEFGHJKLMN]))(\..*)?'),
    (        'Cyan',               'JN.1', r'((JN\.1)|(K[PQRSUVWYZ])|(L[ABCDEFGHJKLMNPQRSTUWYZ])|(M[ABCDEFGHJKLMN]))(\..*)?'),
    (    'DarkBLue',               'KP.2', r'KP\.2(\..*)?'),
    (   'RoyalBlue',             'KP.2.3', r'KP\.2\.3(\..*)?'),
    (   'LightBlue',               'KP.3', r'((KP\.3)|(LW)|(M[CKLM]))(\..*)?'),
