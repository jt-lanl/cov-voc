DefaultLineageTable = [
    ...
    ('LightSkyBlue',               'BA.2', r'((BA\.2)|(B[GHJLMNPRSY])|(C[ABHJMV])|(D[DSV])|(E[JP])|(F[JKRSV])|(G[PQ])|(J[LNPQV])|(K[GPQRSUVWYZ])|(L[ABCDEFGHJKLMNPQRSTUVWYZ])|(M[ABCDEFGHJKLMNPQRSTUVWYZ]))(\..*)?'),
    ...
    (  'DodgerBlue',            'BA.2.86', r'((BA\.2\.86)|(J[NQ])|(K[PQRSUVWYZ])|(L[ABCDEFGHJKLMNPQRSTUVWYZ])|(M[ABCDEFGHJKLMNPQRSTUVWYZ]))(\..*)?'),
    (        'Cyan',               'JN.1', r'((JN\.1)|(K[PQRSUVWYZ])|(L[ABCDEFGHJKLMNPQRSTUWYZ])|(M[ABCDEFGHJKLMNQRSTUVWYZ]))(\..*)?'),
    (   'Goldenrod',               'KP.1', r'((KP\.1)|(LP)|(M[GU]))(\..*)?'),
    (       'Brown',           'KP.1.1.3', r'((KP\.1\.1\.3)|(LP))(\..*)?'),
    (   'RoyalBlue',               'KP.2', r'((KP\.2)|(MW))(\..*)?'),
    (    'DarkBlue',             'KP.2.3', r'((KP\.2\.3)|(MW))(\..*)?'),
    (        'Plum',               'KP.3', r'((KP\.3)|(LW)|(M[CKLMRY]))(\..*)?'),
