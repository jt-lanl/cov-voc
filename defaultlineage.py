DefaultLineageTable = [
    ...
    (   'RoyalBlue',               'BA.2', r'((BA\.2)|(B[GHJLMNPRSY])|(C[ABHJMV])|(D[DSV])|(E[JP])|(F[JKRSV])|(G[PQ])|(J[LNPQV])|(K[GPQRSUVWYZ])|(L[ABC]))(\..*)?'),
    ...
    (  'DodgerBlue',            'BA.2.86', r'((BA\.2\.86)|(J[NQ])|(K[PQRSUVWYZ])|(L[ABC]))(\..*)?'),
    (        'Cyan',               'JN.1', r'((JN\.1)|(K[PQRSUVWYZ])|(L[ABC]))(\..*)?'),
    (    'DarkBLue',               'KP.2', r'KP\.2(\..*)?'),
    (   'LightBlue',               'KP.3', r'KP\.3(\..*)?'),
    (   'SlateBlue',                'XDQ', r'XDQ(\..*)?'),
    (      'Yellow',           'KZ.1.1.1', r'KZ\.1\.1\.1(\..*)?'),
