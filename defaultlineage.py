DefaultLineageTable = [
    ...
    ( 'ForestGreen',                'XDV', r'((XDV)|(NB)|(P[NQ])|(Q[LN])|(R[CHJKQR]))(\..*)?'),
    (   'LawnGreen',           'NB.1.8.1', r'((NB\.1\.8\.1)|(PQ)|(R[CHJKQR]))(\..*)?'),
    (  'DodgerBlue',                'XFG', r'((XFG)|(Q[FKQSTWYZ])|(R[BLMNPV]))(\..*)?'),
    (       'Khaki',            'XFG.1.1', r'((XFG\.1\.1)|(RP))(\..*)?'),
    (      'Orange',          'XFG.3.3.1', r'XFG\.3\.3\.1(\..*)?'),
    (   'Turquoise',          'XFG.3.4.1', r'((XFG\.3\.4\.1)|(QF))(\..*)?'),
    (   'PaleGreen',           'XFG.14.1', r'((XFG\.14\.1)|(RL))(\..*)?'),
    (      'Indigo',             'PE.1.4', r'PE\.1\.4(\..*)?'),
    (      '59a14f',             'BA.3.2', r'((BA\.3\.2)|(R[DESTU]))(\..*)?'),
    (       'Black',                'XFZ', r'XFZ(\..*)?'),
