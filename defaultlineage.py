DefaultLineageTable = [
    ...
    ( 'ForestGreen',                'XDV', r'((XDV)|(NB)|(P[NQ])|(Q[LN])|(R[CHJKQRYZ])|(S[AFGH]))(\..*)?'),
    (   'LawnGreen',           'NB.1.8.1', r'((NB\.1\.8\.1)|(PQ)|(R[CHJKQRYZ])|(S[AFGH]))(\..*)?'),
    (  'DodgerBlue',                'XFG', r'((XFG)|(Q[FKQSTWYZ])|(R[BLMNPV])|(S[BCDEP]))(\..*)?'),
