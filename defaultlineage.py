DefaultLineageTable = [
    ...
    ('LightSkyBlue',               'BA.2', r'((BA\.2)|(B[GHJLMNPRSY])|(C[ABHJMV])|(D[DSV])|(E[JP])|(F[JKRSV])|(G[PQ])|(J[LNPQV])|(K[GPQRSUVWYZ])|(L[ABCDEFGHJKLMNPQRSTUVWYZ])|(M[ABCDEFGHJKLMNPQRSTUVWYZ])|(N[ACDEFGHJKLMNPQRSTUVWYZ])|(P[ABCDEFGHJKLMPRSVWYZ])|(Q[ABCDEHJMPRUV]))(\..*)?'),
    ...
    (  'DodgerBlue',            'BA.2.86', r'((BA\.2\.86)|(J[NQ])|(K[PQRSUVWYZ])|(L[ABCDEFGHJKLMNPQRSTUVWYZ])|(M[ABCDEFGHJKLMNPQRSTUVWYZ])|(N[ACDEFGHJKLMNPQRSTUVWYZ])|(P[ABCDEFGHJKLMPRSVWYZ])|(Q[ABCDEHJMPRUV]))(\..*)?'),
    (        'Cyan',               'JN.1', r'((JN\.1)|(K[PQRSUVWYZ])|(L[ABCDEFGHJKLMNPQRSTUWYZ])|(M[ABCDEFGHJKLMNQRSTUVWYZ])|(N[ACDEFGHJKLMNPQRSTUVWYZ])|(P[ABCDEFGHJKLMPRSVWYZ])|(Q[ABCDEHJMPRUV]))(\..*)?'),
    (       'Brown',           'KP.1.1.3', r'((KP\.1\.1\.3)|(LP)|(N[WY])|(P[DFPR])|(Q[EHMU]))(\..*)?'),
    ...
    (   'Turquoise',                'XEC', r'((XEC)|(P[TU])|(QG))(\..*)?'),
    (   'PaleGreen',             'XEC.25', r'XEC\.25(\..*)?'),
    (       'Khaki',             'LP.8.1', r'((LP\.8\.1)|(N[WY])|(P[DFPR])|(Q[EHMU]))(\..*)?'),
    (       'Coral',           'LP.8.1.1', r'((LP\.8\.1\.1)|(NY)|(QU))(\..*)?'),
