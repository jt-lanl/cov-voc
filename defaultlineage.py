DefaultLineageTable = [
    ...
    ('LightSkyBlue',               'BA.2', r'((BA\.2)|(B[GHJLMNPRSY])|(C[ABHJMV])|(D[DSV])|(E[JP])|(F[JKRSV])|(G[PQ])|(J[LNPQV])|(K[GPQRSUVWYZ])|(L[ABCDEFGHJKLMNPQRSTUVWYZ])|(M[ABCDEFGHJKLMNPQRSTUVWYZ])|(N[ACDEFGHJKLMNPQRSTUVWYZ])|(P[ABCDEFGHJKLMPRSVWYZ])|(Q[ABCDEHJMPRUV])|(R[FG]))(\..*)?'),
    ...
    (        'Cyan',               'JN.1', r'((JN\.1)|(K[PQRSUVWYZ])|(L[ABCDEFGHJKLMNPQRSTUWYZ])|(M[ABCDEFGHJKLMNQRSTUVWYZ])|(N[ACDEFGHJKLMNPQRSTUVWYZ])|(P[ABCDEFGHJKLMPRSVWYZ])|(Q[ABCDEHJMPRUV])|(R[FG]))(\..*)?'),
    (       'Brown',           'KP.1.1.3', r'((KP\.1\.1\.3)|(LP)|(N[WY])|(P[DFPR])|(Q[EHMU])|(RG))(\..*)?'),
    (   'RoyalBlue',               'KP.2', r'((KP\.2)|(MW)|(N[GHKMN]))(\..*)?'),
    (    'DarkBlue',             'KP.2.3', r'((KP\.2\.3)|(MW)|(N[GKMN]))(\..*)?'),
    (        'Plum',               'KP.3', r'((KP\.3)|(LW)|(M[CKLMRY])|(N[PQRV])|(P[ABEGHJM])|(QP))(\..*)?'),
    (     'Magenta',           'KP.3.1.1', r'((KP\.3\.1\.1)|(MC)|(P[AEHJ])|(QP))(\..*)?'),
    (       'Coral',             'LP.8.1', r'((LP\.8\.1)|(N[WY])|(P[DFPR])|(Q[EHMU])|(RG))(\..*)?'),
    (   'FireBrick',               'LF.7', r'((LF\.7)|(NT)|(P[CLVWYZ])|(Q[ABCDJRV])|(RF))(\..*)?'),
    ( 'ForestGreen',                'XDV', r'((XDV)|(NB)|(P[NQ])|(Q[LN])|(R[CHJKQRYZ])|(S[AFGHVY]))(\..*)?'),
    (   'LawnGreen',           'NB.1.8.1', r'((NB\.1\.8\.1)|(PQ)|(R[CHJKQRYZ])|(S[AFGHVY]))(\..*)?'),
    (  'DodgerBlue',                'XFG', r'((XFG)|(Q[FKQSTWYZ])|(R[BLMNPV])|(S[BCDEPTUW]))(\..*)?'),
    (       'Khaki',            'XFG.1.1', r'((XFG\.1\.1)|(RP))(\..*)?'),
    (      'Orange',          'XFG.3.3.1', r'((XFG\.3\.3\.1)|(SE))(\..*)?'),
    (   'Turquoise',          'XFG.3.4.1', r'((XFG\.3\.4\.1)|(QF)|(SD))(\..*)?'),
    (   'PaleGreen',           'XFG.14.1', r'((XFG\.14\.1)|(RL))(\..*)?'),
    (      'Indigo',             'PE.1.4', r'PE\.1\.4(\..*)?'),
    (      '59a14f',             'BA.3.2', r'((BA\.3\.2)|(R[DESTU])|(S[JKLMNQS]))(\..*)?'),
    (       'Black',                'XFJ', r'((XFJ)|(R[AW]))(\..*)?'),
    (     'Magenta',          'JN.1.18.5', r'((JN\.1\.18\.5)|(LS))(\..*)?'),
