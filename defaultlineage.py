DefaultLineageTable = [
    ...
    ('LightSkyBlue',               'BA.2', r'((BA\.2)|(B[GHJLMNPRSY])|(C[ABHJMV])|(D[DSV])|(E[JP])|(F[JKRSV])|(G[PQ])|(J[LNPQV])|(K[GPQRSUVWYZ])|(L[ABCDEFGHJKLMNPQRSTUVWYZ])|(M[ABCDEFGHJKLMNPQRSTUVWYZ])|(N[ACDEFGHJKLMNPQRSTUVWYZ])|(P[ABCDEFG]))(\..*)?'),
    ...
    (  'DodgerBlue',            'BA.2.86', r'((BA\.2\.86)|(J[NQ])|(K[PQRSUVWYZ])|(L[ABCDEFGHJKLMNPQRSTUVWYZ])|(M[ABCDEFGHJKLMNPQRSTUVWYZ])|(N[ACDEFGHJKLMNPQRSTUVWYZ])|(P[ABCDEFG]))(\..*)?'),
    (        'Cyan',               'JN.1', r'((JN\.1)|(K[PQRSUVWYZ])|(L[ABCDEFGHJKLMNPQRSTUWYZ])|(M[ABCDEFGHJKLMNQRSTUVWYZ])|(N[ACDEFGHJKLMNPQRSTUVWYZ])|(P[ABCDEFG]))(\..*)?'),
    (       'Brown',           'KP.1.1.3', r'((KP\.1\.1\.3)|(LP)|(N[WY])|(P[DF]))(\..*)?'),
    (   'RoyalBlue',               'KP.2', r'((KP\.2)|(MW)|(N[GHKMN]))(\..*)?'),
    (    'DarkBlue',             'KP.2.3', r'((KP\.2\.3)|(MW)|(N[GKMN]))(\..*)?'),
    (        'Plum',               'KP.3', r'((KP\.3)|(LW)|(M[CKLMRY])|(N[PQRV])|(P[ABEG]))(\..*)?'),
    (     'Magenta',           'KP.3.1.1', r'((KP\.3\.1\.1)|(MC)|(P[AE]))(\..*)?'),
    (   'Turquoise',                'XEC', r'XEC(\..*)?'),
    (   'PaleGreen',              'XEC.4', r'XEC\.4(\..*)?'),
    (       'Khaki',             'LP.8.1', r'((LP\.8\.1)|(N[WY])|(P[DF]))(\..*)?'),
    (       'Coral',           'LP.8.1.1', r'((LP\.8\.1\.1)|(NY))(\..*)?'),
    (   'FireBrick',               'LF.7', r'((LF\.7)|(NT)|(PC))(\..*)?'),
    ( 'ForestGreen',                'XDV', r'((XDV)|(NB))(\..*)?'),
    (   'LawnGreen',           'NB.1.8.1', r'NB\.1\.8\.1(\..*)?'),
