...
DefaultLineageTable = [
    ...
    ('YellowGreen', 'BA.5/B[EFKTUVWZ]/C[CDEFGKLNRTU]/D[ABEFGHJQ]', r'(BA\.5(\..*)?)|(B[EFKTUVWZ]\..*)|(C[CDEFGKLNQRTU]\..*)|(D[ABEFGHJQ]\..*)'),
    (    'Thistle',               'BA.2.75/B[LMNRY]/C[BHV]/D[SV]', r'(BA\.2\.75(\..*)?)|(B[LMNRY]\..*)|(C[BHV]\..*)|(D[SV]\..*)'),
    ...
    (       'Pink',                              'BQ.1.1.22-like', r'(BQ\.1\.1\.((22)|(13)|(20)|(24)|(10)|(21))(\..*)?)|(BQ\.1\.18(\..*)?)'),
    ('ForestGreen',                                         'XBB', r'XBB(\..*)?'),
    (    'Crimson',                                     'XBB.1.5', r'XBB\.1\.5(\..*)?'),
    (       'Blue',                                'BA.2.3.20/CM', r'(BA\.2\.3\.20(\..*)?)|(CM\..*)'),
    (    'DarkRed',                              'BA.5.2.18-like', r'(BA\.5\.2\.18(\..*)?)|(BF\.16(\..*)?)|(C[RQ]\..*)'),
    (      'Khaki',                               'BM.1.1.1-like', r'(BM\.1\.1\.1)|(XBF(\..*)?)|(CJ(\..*)?)'),
